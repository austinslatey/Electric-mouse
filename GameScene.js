  ...
  create() {
    ...
    gameState.attackButton.on("pointerup", () => {
      ...
      if (game.input.enabled) {
        ...
        if (randomMove === 0) {
          ...
          gameState.player.sprite.anims.play(
          ...
          gameState.player.health -= 1;
          gameState.playerHealthBar.text = `The HP: ${gameState.player.health}`;
          gameState.player.sprite.anims.play("playerAttack");
          gameState.computerSprite.anims.play(
    ...
    gameState.defendButton.on("pointerup", () => {
      ...
      if (game.input.enabled) {
        ...
        let randomMove = Math.floor(Math.random() * 3);
      if (randomMove === 0) {
        gameState.information.text = `The ${gameState.computerSprite.texture.key} lost 1 HP!`;
        ...
        gameState.information.text = `The player lost 4 HP`;
        gameState.playerMove.text = "Defend";
        gameState.computerMove.text = "Special Attack";
        gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
        ...
        gameState.player.sprite.anims.play("playerDefend");
        gameState.computerSprite.anims.play(
          `${gameState.computerSprite.name}Special`
        );
      }
    }
    });
